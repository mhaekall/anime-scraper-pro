...
from routes.home_v2 import router as home_v2_router
from routes.stream_v2 import router as stream_v2_router
...
app.include_router(home.router,  prefix="/api",    tags=["Home v1"])
app.include_router(anime.router, prefix="/api",    tags=["Anime v1"])
app.include_router(stream.router, prefix="/api",   tags=["Stream v1"])

# ── v2 Routes (new architecture) ─────────────────────────────────────────
app.include_router(home_v2_router,   prefix="/api", tags=["Home v2"])
app.include_router(stream_v2_router, prefix="/api", tags=["Stream v2"])
